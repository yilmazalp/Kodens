...
if LINUX:
    ...
    if _psplatform.HAS_PRLIMIT:
        from ._pslinux import RLIM_INFINITY  # NOQA
        from ._pslinux import RLIMIT_AS  # NOQA
        from ._pslinux import RLIMIT_CORE  # NOQA
        from ._pslinux import RLIMIT_CPU  # NOQA
        from ._pslinux import RLIMIT_DATA  # NOQA
        from ._pslinux import RLIMIT_FSIZE  # NOQA
        from ._pslinux import RLIMIT_LOCKS  # NOQA
        from ._pslinux import RLIMIT_MEMLOCK  # NOQA
        from ._pslinux import RLIMIT_NOFILE  # NOQA
        from ._pslinux import RLIMIT_NPROC  # NOQA
        from ._pslinux import RLIMIT_RSS  # NOQA
        from ._pslinux import RLIMIT_STACK  # NOQA
    ...
    from ._pswindows import ABOVE_NORMAL_PRIORITY_CLASS  # NOQA
    from ._pswindows import BELOW_NORMAL_PRIORITY_CLASS  # NOQA
    from ._pswindows import HIGH_PRIORITY_CLASS  # NOQA
    from ._pswindows import IDLE_PRIORITY_CLASS  # NOQA
    from ._pswindows import NORMAL_PRIORITY_CLASS  # NOQA
    from ._pswindows import REALTIME_PRIORITY_CLASS  # NOQA
