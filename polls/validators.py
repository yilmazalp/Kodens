    ...
    def validate(self, password, user=None):
        if len(password) < self.min_length:
            raise ValidationError(
                ungettext(
                    "Parola çok kısa. En az %(min_length)d karakter içermelidir.",
                    "Parola çok kısa. En az %(min_length)d karakter içermelidir.",
                    self.min_length
                ),
        ...
        for attribute_name in self.user_attributes:
            ...
            for value_part in value_parts:
                if SequenceMatcher(a=password.lower(), b=value_part.lower()).quick_ratio() > self.max_similarity:
                    ...
                    raise ValidationError(
                        _("Parola %(verbose_name)s ile benzerlik taşıyor: ."),
                        code='password_too_similar',
                        params={'verbose_name': verbose_name},
                    )

    def get_help_text(self):
        return _("Parolanız diğer kullanıcıların parolsıyla aynı olamaz.")
...
class CommonPasswordValidator(object):
    ...
    def get_help_text(self):
        return _("Kolay tahmin edilen parola kullanmamalısınız.")
...
class NumberValidator(object):
    def validate(self, password, user=None):
        if not re.findall('\d', password):
            raise ValidationError(
                _("Parola en az bir rakam içermelidir."),
...
class UppercaseValidator(object):
    def validate(self, password, user=None):
        if not re.findall('[A-Z]', password):
            raise ValidationError(
                _("Parola en az bir büyük harf içermelidir."),
...
class LowercaseValidator(object):
    def validate(self, password, user=None):
        if not re.findall('[a-z]', password):
            raise ValidationError(
                _("Parola en az bir küçük harf içermelidir."),
...
class SymbolValidator(object):
    def validate(self, password, user=None):
        if not re.findall('[()[\]{}|\\`~!@#$%^&amp;*_\-+=;:\'",<>./?]', password):
            raise ValidationError(
                _("Parola en az bir sembol içermelidir: " +
                  "()[]{}|\`~!@#$%^&amp;*_-+=;:'\",<>./?"),
    ...
    def get_help_text(self):
        return _(
            "Parola en az bir sembol içermelidir: " +
            "()[]{}|\`~!@#$%^&amp;*_-+=;:'\",<>./?"
        )